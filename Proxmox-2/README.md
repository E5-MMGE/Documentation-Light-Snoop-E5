...
16. Puis faites "Next"
</br>![Proxmox Network](/Proxmox-2/Img/Pr-2_Install-6.png?raw=true "Proxmox Network")
17. Vérifiez les informations, laissez "Reboot" coché et faites "Install"
</br>![Proxmox Summary](/Proxmox-2/Img/Pr-2_Install-7.png?raw=true "Proxmox Summary")
18. Attendez que l'installation se termine et que le Proxmox redémarre
</br>![Proxmox End](/Proxmox-2/Img/Pr-2_Install-8.png?raw=true "Proxmox End")
...
</br>![Proxmox Login](/Proxmox-2/Img/Pr-2_ISO-1.png?raw=true "Proxmox Login")
2. Naviguez jusqu'à "Var" > "Lib" > "VZ" > "Template" > "ISO"
```sh
cd /var/lib/vz/template/iso
```
</br>![Proxmox Location](/Proxmox-2/Img/Pr-2_ISO-2.png?raw=true "Proxmox Location")</br>
...
```
</br>![Proxmox ISOs](/Proxmox-2/Img/Pr-2_ISO-3.png?raw=true "Proxmox wget ISOs")

4. Vérifiez que les ISOs sont bien présentes
```sh
ls
```
</br>![Proxmox ISOs](/Proxmox-2/Img/Pr-2_ISO-4.png?raw=true "Proxmox ls ISOs")
